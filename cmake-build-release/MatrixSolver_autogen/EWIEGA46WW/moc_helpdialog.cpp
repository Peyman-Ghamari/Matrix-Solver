...
static constexpr auto qt_meta_stringdata_ZN10HelpDialogE = QtMocHelpers::stringData(
    "HelpDialog",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10HelpDialogE[] = {
...
Q_CONSTINIT const QMetaObject HelpDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10HelpDialogE.offsetsAndSizes,
    qt_meta_data_ZN10HelpDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10HelpDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *HelpDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10HelpDialogE.stringdata0))
